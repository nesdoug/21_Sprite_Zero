...
;
	jmp     L062A
L0820:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L062A:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
L0825:	lda     #$00
L081D:	sta     _map_loaded
;
; temp5 = BoxGuy1.x;
;
L06A3:	lda     _BoxGuy1+1
	sta     _temp5+1
	lda     _BoxGuy1
	sta     _temp5
;
...
;
L0761:	ldy     _coordinates
	lda     _c_map2,y
L0838:	sta     _collision
;
